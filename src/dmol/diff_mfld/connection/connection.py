...
import dmol.diff_mfld.connection.geod_ivp_bvp as geod_ivp_bvp
import dmol.diff_mfld.connection.pt_vec as pt_vec
...
class TangentConnection(Connection[TangentBundle]):
    ...
    def exp(self, p: Point | torch.Tensor, v: Vec) -> Tuple[Point, Curve]:
        ...
        return geod_ivp_bvp.ivp_exp_map(p, v, self)
